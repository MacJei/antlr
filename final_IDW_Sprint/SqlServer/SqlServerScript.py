...
class TSQL():
    ...
    def loadStatements(self):
        ...
        try:        
            ...
            self.cntx.logger.add_log('WARN', 'Using unparsed script content. Result may be inconsistent.')
        else:
        ...
        self.cntx.logger.add_log('INFO', 'Identifying statements in scope of the converter')
